...
export function JourneyEnd() {
  return (
    <section className="relative w-full min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-24 z-10">
      <motion.div 
      ...
      >
        <div className="w-[1px] h-24 bg-gradient-to-b from-transparent to-(--color-charcoal)/30 mb-8" />
